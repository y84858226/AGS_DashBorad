...
public class BrowseNodeDefectiveAsin implements Serializable {
	...
	public BrowseNodeDefectiveAsin(String sourceCountry, String targetCountry, String year, String week, String asin,
			...
			String rootBrowseNodeId, String browseNodeName, String edgePathName, String isLeafNode) {
	...
	public String toString() {
		return sourceCountry + "," + targetCountry + "," + year + "," + week + "," + asin + "," + productGroupCode + ","
				...
				+ browseNodeName + "\",\"" + edgePathName + "\"," + isLeafNode + "\r\n";
	}
	
	public String getTitle(){
		return "sourceCountry,targetCountry,year,week,asin,productGroupCode,productGroupDescription,pl,browseNodeId,rootBrowseNodeId,browseNodeName,edgePathName,isLeafNode\r\n";
	}
}
